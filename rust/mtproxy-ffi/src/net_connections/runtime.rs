...
type EventHandler = Option<unsafe extern "C" fn(c_int, *mut c_void, *mut EventDescr) -> c_int>;
...
#[repr(C)]
struct ListeningConnectionInfo {
    timer: EventTimer,
    fd: c_int,
    generation: c_int,
    flags: c_int,
...
struct EventDescr {
    ...
    refcnt: c_longlong,
    work: Option<unsafe extern "C" fn(c_int, *mut c_void, *mut EventDescr) -> c_int>,
    data: *mut c_void,
}
...
pub(super) struct ConnTargetInfo {
    ...
    custom_field: c_int,
    next_target: ConnTargetJob,
    prev_target: ConnTargetJob,
    hnext: ConnTargetJob,
    global_refcnt: c_int,
}
