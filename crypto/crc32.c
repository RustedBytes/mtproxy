...
static unsigned crc32_partial_rust (const void *data, long len, unsigned crc) {
  return mtproxy_ffi_crc32_partial ((const uint8_t *) data, rust_len_from_long (len), (uint32_t) crc);
}

static uint64_t crc64_partial_rust (const void *data, long len, uint64_t crc) {
  return mtproxy_ffi_crc64_partial ((const uint8_t *) data, rust_len_from_long (len), crc);
}
...
void gf32_compute_powers_generic (unsigned *P, int size, unsigned poly) {
  ...
  mtproxy_ffi_gf32_compute_powers_generic ((uint32_t *) P, rust_len_from_int (size), (uint32_t) poly);
}
...
unsigned gf32_combine_generic (unsigned *powers, unsigned crc1, int64_t len2) {
  ...
  return mtproxy_ffi_gf32_combine_generic ((const uint32_t *) powers, (uint32_t) crc1, len2);
}
...
uint64_t gf32_combine_clmul (unsigned *powers, unsigned crc1, int64_t len2) {
  ...
  return mtproxy_ffi_gf32_combine_clmul ((const uint32_t *) powers, (uint32_t) crc1, len2);
}
...
int crc32_repair_bit (unsigned char *input, int l, int k) {
  return mtproxy_ffi_crc32_repair_bit ((uint8_t *) input, rust_len_from_int (l), k);
}

int crc32_check_and_repair (void *input, int l, unsigned *input_crc32, int force_exit) {
  int rc = mtproxy_ffi_crc32_check_and_repair ((uint8_t *) input, rust_len_from_int (l), (uint32_t *) input_crc32);
  if (!force_exit) {
    return rc;
  }
