...
TREE_PREFIX TREE_NODE_TYPE *SUFFIX(tree_lookup_, TREE_NAME)(TREE_NODE_TYPE *T,
                                                            X_TYPE x)
    __attribute__((unused));
TREE_PREFIX TREE_NODE_TYPE *SUFFIX(tree_lookup_next_,
                                   TREE_NAME)(TREE_NODE_TYPE *T, X_TYPE x)
    __attribute__((unused));
#ifdef TREE_NOPTR
TREE_PREFIX TREE_NODE_TYPE *SUFFIX(tree_lookup_p_, TREE_NAME)(TREE_NODE_TYPE *T,
                                                              X_TYPE *x)
    __attribute__((unused));
TREE_PREFIX X_TYPE *SUFFIX(tree_lookup_value_, TREE_NAME)(TREE_NODE_TYPE *T,
                                                          X_TYPE x)
    __attribute__((unused));
...
TREE_PREFIX X_TYPE SUFFIX(tree_lookup_ptr_, TREE_NAME)(TREE_NODE_TYPE *T,
    ...
    __attribute__((unused));
#ifdef TREE_PTHREAD
TREE_PREFIX X_TYPE SUFFIX(tree_lookup_sub_ptr_, TREE_NAME)(TREE_NODE_TYPE **T,
                                                           X_TYPE x)
    __attribute__((unused));
#endif
#endif
...
TREE_PREFIX TREE_NODE_TYPE *SUFFIX(tree_insert_, TREE_NAME)(TREE_NODE_TYPE *T,
                                                            X_TYPE x, Y_TYPE y
#ifdef TREE_WEIGHT
                                                            ,
                                                            int weight
...
TREE_PREFIX void SUFFIX(tree_insert_sub_, TREE_NAME)(TREE_NODE_TYPE **T,
                                                     X_TYPE x, Y_TYPE y
#ifdef TREE_WEIGHT
                                                     ,
                                                     int weight
...
#ifdef TREE_NOPTR
TREE_PREFIX TREE_NODE_TYPE *
    SUFFIX(tree_insert_p_, TREE_NAME)(TREE_NODE_TYPE *T, X_TYPE *x, Y_TYPE y
#ifdef TREE_WEIGHT
                                      ,
                                      int weight
#endif
...
TREE_PREFIX TREE_NODE_TYPE *SUFFIX(tree_merge_, TREE_NAME)(TREE_NODE_TYPE *L,
                                                           TREE_NODE_TYPE *R)
    __attribute__((unused, warn_unused_result));
TREE_PREFIX TREE_NODE_TYPE *SUFFIX(tree_delete_, TREE_NAME)(TREE_NODE_TYPE *T,
                                                            X_TYPE x)
    __attribute__((unused, warn_unused_result));
TREE_PREFIX void SUFFIX(tree_delete_sub_, TREE_NAME)(TREE_NODE_TYPE **T,
                                                     X_TYPE x)
    __attribute__((unused));
#ifdef TREE_NOPTR
TREE_PREFIX TREE_NODE_TYPE *SUFFIX(tree_delete_p_, TREE_NAME)(TREE_NODE_TYPE *T,
                                                              X_TYPE *x)
    __attribute__((unused, warn_unused_result));
#endif
...
TREE_PREFIX void SUFFIX(tree_act_ex_, TREE_NAME)(TREE_NODE_TYPE *T,
                                                 ...
                                                 void *ex)
    __attribute__((unused));
TREE_PREFIX void SUFFIX(tree_act_ex2_,
                        TREE_NAME)(TREE_NODE_TYPE *T,
                                   void (*act)(X_TYPE, void *, void *),
                                   void *ex, void *ex2) __attribute__((unused));
TREE_PREFIX void SUFFIX(tree_act_ex3_,
                        TREE_NAME)(TREE_NODE_TYPE *T,
...
#ifdef TREE_NOPTR
TREE_PREFIX TREE_NODE_TYPE *SUFFIX(tree_insert_p_, TREE_NAME)(TREE_NODE_TYPE *T,
                                                              X_TYPE *x,
                                                              Y_TYPE y
#ifdef TREE_WEIGHT
                                                              ,
...
TREE_PREFIX TREE_NODE_TYPE *SUFFIX(tree_get_min_,
                                   TREE_NAME)(TREE_NODE_TYPE *T) {
  while (T && T->left) {
    T = T->left;
  }
...
TREE_PREFIX TREE_NODE_TYPE *SUFFIX(tree_get_max_,
                                   TREE_NAME)(TREE_NODE_TYPE *T) {
  while (T && T->right) {
    T = T->right;
  }
...
TREE_PREFIX void SUFFIX(tree_check_, TREE_NAME)(TREE_NODE_TYPE *T) {
  ...
  if (T->left) {
    assert(Y_CMP(T->left->y, T->y) <= 0);
    assert(X_CMP(T->left->x, T->x) < 0);
  }
  if (T->right) {
    assert(Y_CMP(T->right->y, T->y) <= 0);
...
TREE_PREFIX int SUFFIX(tree_count_, TREE_NAME)(TREE_NODE_TYPE *T) {
  ...
  return 1 + SUFFIX(tree_count_, TREE_NAME)(T->left) +
         SUFFIX(tree_count_, TREE_NAME)(T->right);
}
...
TREE_PREFIX void SUFFIX(tree_free_, TREE_NAME)(TREE_NODE_TYPE *T) {
  ...
  assert(!T->refcnt);
  if (T->left) {
    SUFFIX(tree_free_, TREE_NAME)(T->left);
  }
  if (T->right) {
    SUFFIX(tree_free_, TREE_NAME)(T->right);
  }
#else
  assert(T);
#endif
...
TREE_PREFIX void SUFFIX(tree_relax_, TREE_NAME)(TREE_NODE_TYPE *T) {
  T->count =
      1 + (T->left ? T->left->count : 0) + (T->right ? T->right->count : 0);
}
#endif
#ifdef TREE_WEIGHT
TREE_PREFIX void SUFFIX(tree_relax_, TREE_NAME)(TREE_NODE_TYPE *T) {
  T->count = T->weight + (T->left ? T->left->count : 0) +
...
TREE_PREFIX TREE_NODE_TYPE *SUFFIX(get_tree_ptr_,
                                   TREE_NAME)(TREE_NODE_TYPE **T) {
  return get_ptr_multithread_copy((void **)T,
                                  (void *)SUFFIX(incref_tree_ptr_, TREE_NAME));
}
