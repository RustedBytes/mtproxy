...
extern int32_t mtproxy_ffi_tcp_rpc_server_packet_header_malformed (int32_t packet_len);
extern int32_t mtproxy_ffi_tcp_rpc_server_packet_len_state (int32_t packet_len, int32_t max_packet_len);
